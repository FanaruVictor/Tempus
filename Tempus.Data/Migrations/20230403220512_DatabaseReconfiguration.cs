...
{
    /// <inheritdoc />
    public partial class DatabaseReconfiguration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupCategories", x => new { x.GroupId, x.CategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupCategories_CategoryId",
